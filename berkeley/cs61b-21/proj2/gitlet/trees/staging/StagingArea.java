...
public class StagingArea implements IGLStagingArea, Serializable {
    ...
    public void commitStagedFiles(String message) {
        ...
        if (MergeTracker.hasMergeData()) {
            String firstParentShorthand = Utils.splitHash(mergeEntry.getFirstParentHash(), Utils.HASH_SEVEN)[0];
            String secondParentShorthand = Utils.splitHash(mergeEntry.getSecondParentHash(), Utils.HASH_SEVEN)[0];
