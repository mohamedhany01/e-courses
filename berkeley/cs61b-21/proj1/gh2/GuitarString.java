...
public class GuitarString {
    ...
    public void tic() {
        ...
        double firstNoise = buffer.removeFirst().doubleValue();
        double nextNoise = buffer.getFirst().doubleValue();
        double newDouble = DECAY * 0.5 * (firstNoise + nextNoise);
    ...
    public double sample() {
        ...
        return buffer.getFirst().doubleValue();
    }
}
