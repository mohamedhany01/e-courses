...
@Test
    ...
    @Test
    public void check10_000AndThenRemoveUntil9_999() {
        Deque<Integer> lld1 = new ArrayDeque<>();
        ...
        for (int i = 0; i < 9999; i++) {
            // TODO removeLast() need to refactor
            lld1.removeFirst();
        }
        assertEquals(0, lld1.get(0).intValue());
        assertEquals(null, lld1.get(-1));
        assertEquals(null, lld1.get(lld1.size() + 1));
        assertEquals(1, lld1.size());
    }
}
