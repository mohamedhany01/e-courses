...
const binaryToAscii = str => {
  const binaryToDecimals =  binaryStringToArray(str).map((binary) => parseInt(binary, 2));
  const decimalsToChars = String.fromCharCode(...binaryToDecimals);
  
  return decimalsToChars;
};
